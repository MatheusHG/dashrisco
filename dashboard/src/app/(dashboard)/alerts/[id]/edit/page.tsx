...
import {
  ...
  AlertTriangle, CheckSquare, Save, Share2,
} from "lucide-react";
              ...
              {createPanelTask && (
                <div className="space-y-3 pt-3 border-t border-border/50">
                  ...
                  <div className="flex gap-2">
                    <Input value={newCheckItem} onChange={(e) => setNewCheckItem(e.target.value)} placeholder="Ex: Verificar FTD do usuario" className="h-9 rounded-xl text-sm flex-1" onKeyDown={(e) => {
                    ...
                    <Button type="button" variant="outline" size="sm" className="rounded-xl gap-1 shrink-0" disabled={!newCheckItem.trim()} onClick={() => { setChecklist([...checklist, newCheckItem.trim()]); setNewCheckItem(""); }}>
